...
contract NFTXFlashSwipe is IERC3156FlashBorrowerUpgradeable {
	...
	function onFlashLoan(
		...
		require(initiator == address(this), "FlashSwipe: Untrusted loan initiator");
		require(msg.sender == address(tempLender), "FlashSwipe: Untrusted lender");
