...
async function main() {
	...
	const stakingZap = await StakingZap.deploy(rinkebyVaultFactory, rinkebySushiRouter);
	...
	const vaultFactory = await ethers.getContractAt('NFTXVaultFactoryUpgradeable', rinkebyVaultFactory);
