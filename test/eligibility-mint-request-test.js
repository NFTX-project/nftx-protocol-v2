...
describe('Main', function () {
	before('Setup', async () => {
		...
		const RequestEligibility = await ethers.getContractFactory('NFTXMintRequestEligibility');
		reqElig = await upgrades.deployProxy(RequestEligibility, [primary.address, vault.address, false, []], {
