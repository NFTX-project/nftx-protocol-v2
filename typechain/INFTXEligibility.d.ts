...
interface INFTXEligibilityInterface extends ethers.utils.Interface {
  functions: {
...
export class INFTXEligibility extends BaseContract {
  ...
  interface: INFTXEligibilityInterface;
