...
interface NFTXDeferEligibilityInterface extends ethers.utils.Interface {
  functions: {
    "__NFTXEligibility_init(address,uint256)": FunctionFragment;
    ...
    "deferAddress()": FunctionFragment;
    "deferVaultId()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "deferAddress",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "deferVaultId",
    values?: undefined
  ): string;
...
export type NFTXEligibilityInitEvent = TypedEvent<
  [string, BigNumber] & { deferAddress: string; deferralVaultId: BigNumber }
>;

export class NFTXDeferEligibility extends BaseContract {
  ...
  interface: NFTXDeferEligibilityInterface;

  functions: {
    __NFTXEligibility_init(
      _deferAddress: string,
      _deferVaultId: BigNumberish,
    ...
    deferAddress(overrides?: CallOverrides): Promise<[string]>;

    deferVaultId(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  filters: {
    "NFTXEligibilityInit(address,uint256)"(
      deferAddress?: null,
      deferralVaultId?: null
    ): TypedEventFilter<
      [string, BigNumber],
      { deferAddress: string; deferralVaultId: BigNumber }
    >;
  ...
  estimateGas: {
    ...
    deferAddress(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    deferAddress(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    deferVaultId(overrides?: CallOverrides): Promise<PopulatedTransaction>;
