...
interface NFTXDenyEligibilityInterface extends ethers.utils.Interface {
  functions: {
...
export class NFTXDenyEligibility extends BaseContract {
  ...
  interface: NFTXDenyEligibilityInterface;
