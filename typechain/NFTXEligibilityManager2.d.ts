...
interface NFTXEligibilityManager2Interface extends ethers.utils.Interface {
  functions: {
...
export class NFTXEligibilityManager2 extends BaseContract {
  ...
  interface: NFTXEligibilityManager2Interface;
