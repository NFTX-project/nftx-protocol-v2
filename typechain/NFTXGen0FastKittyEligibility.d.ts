...
interface NFTXGen0FastKittyEligibilityInterface extends ethers.utils.Interface {
  functions: {
...
export class NFTXGen0FastKittyEligibility extends BaseContract {
  ...
  interface: NFTXGen0FastKittyEligibilityInterface;
