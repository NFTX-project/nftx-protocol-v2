...
interface NFTXGen0KittyEligibilityInterface extends ethers.utils.Interface {
  functions: {
...
export class NFTXGen0KittyEligibility extends BaseContract {
  ...
  interface: NFTXGen0KittyEligibilityInterface;
