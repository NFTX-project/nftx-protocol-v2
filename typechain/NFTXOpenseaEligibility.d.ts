...
interface NFTXOpenseaEligibilityInterface extends ethers.utils.Interface {
  functions: {
...
export type NFTXEligibilityInitEvent = TypedEvent<
  [BigNumber] & { collectionId: BigNumber }
>;

export class NFTXOpenseaEligibility extends BaseContract {
  ...
  interface: NFTXOpenseaEligibilityInterface;
  ...
  filters: {
    "NFTXEligibilityInit(uint256)"(
      collectionId?: null
    ): TypedEventFilter<[BigNumber], { collectionId: BigNumber }>;
