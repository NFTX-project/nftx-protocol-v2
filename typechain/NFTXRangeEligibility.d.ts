...
interface NFTXRangeEligibilityInterface extends ethers.utils.Interface {
  functions: {
    "__NFTXEligibility_init(uint256,uint256)": FunctionFragment;
  ...
  events: {
    "NFTXEligibilityInit(uint256,uint256)": EventFragment;
...
export class NFTXRangeEligibility extends BaseContract {
  ...
  interface: NFTXRangeEligibilityInterface;
  ...
  filters: {
    "NFTXEligibilityInit(uint256,uint256)"(
      rangeStart?: null,
      rangeEnd?: null
    ): TypedEventFilter<
      [BigNumber, BigNumber],
