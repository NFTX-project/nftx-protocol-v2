...
interface NFTXUglyEligibilityInterface extends ethers.utils.Interface {
  functions: {
...
export class NFTXUglyEligibility extends BaseContract {
  ...
  interface: NFTXUglyEligibilityInterface;
