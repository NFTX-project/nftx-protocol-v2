...
interface NFTXVaultFactoryUpgradeable2Interface extends ethers.utils.Interface {
  functions: {
    ...
    "twiceNumVaults()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "twiceNumVaults",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class NFTXVaultFactoryUpgradeable2 extends BaseContract {
  ...
  interface: NFTXVaultFactoryUpgradeable2Interface;
  ...
  functions: {
    ...
    twiceNumVaults(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    twiceNumVaults(overrides?: CallOverrides): Promise<PopulatedTransaction>;
