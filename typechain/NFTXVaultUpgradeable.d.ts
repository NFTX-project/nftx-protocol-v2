...
interface NFTXVaultUpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class NFTXVaultUpgradeable extends BaseContract {
  ...
  interface: NFTXVaultUpgradeableInterface;
