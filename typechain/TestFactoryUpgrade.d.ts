...
interface TestFactoryUpgradeInterface extends ethers.utils.Interface {
  functions: {
...
export class TestFactoryUpgrade extends BaseContract {
  ...
  interface: TestFactoryUpgradeInterface;
