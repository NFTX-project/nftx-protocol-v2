...
interface TestVaultUpgradeInterface extends ethers.utils.Interface {
  functions: {
...
export class TestVaultUpgrade extends BaseContract {
  ...
  interface: TestVaultUpgradeInterface;
