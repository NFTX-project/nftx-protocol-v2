...
interface TimelockRewardDistributionTokenImplInterface
  ...
  events: {
    ...
    "Timelocked(address,uint256,uint256)": EventFragment;
...
export class TimelockRewardDistributionTokenImpl extends BaseContract {
  ...
  filters: {
    ...
    "Timelocked(address,uint256,uint256)"(
      user?: null,
      amount?: null,
      until?: null
    ): TypedEventFilter<
      [string, BigNumber, BigNumber],
      { user: string; amount: BigNumber; until: BigNumber }
    >;
