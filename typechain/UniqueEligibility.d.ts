...
interface UniqueEligibilityInterface extends ethers.utils.Interface {
  functions: {
...
export class UniqueEligibility extends BaseContract {
  ...
  interface: UniqueEligibilityInterface;
