...
import type { INFTXVault, INFTXVaultInterface } from "../INFTXVault";
...
export class INFTXVault__factory {
  static readonly abi = _abi;
  static createInterface(): INFTXVaultInterface {
    return new utils.Interface(_abi) as INFTXVaultInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): INFTXVault {
    return new Contract(address, _abi, signerOrProvider) as INFTXVault;
  }
}
